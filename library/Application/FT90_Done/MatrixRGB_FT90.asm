...
LDA.x	R2, #AlignedAddress(GPIO_PIN1_bit+0)
BINS.L	R2, R2, #BitPos(GPIO_PIN1_bit+0)=0
STI.x	GPIO_PIN1_bit+0, #AlignedAddress(R2)
;MatrixRGB_FT90.c,66 :: 		MATRIXRGB_RST = 1;
LDA.x	R2, #AlignedAddress(GPIO_PIN1_bit+0)
BINS.L	R2, R2, #BitPos(GPIO_PIN1_bit+0)=1
STI.x	GPIO_PIN1_bit+0, #AlignedAddress(R2)
