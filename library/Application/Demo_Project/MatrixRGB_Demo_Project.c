...
void system_setup( uint8_t width, uint8_t height );    /**<    Sets up GPIO / SPI / MatrixRGB */
...
void main()
{
    ...
    system_setup( 1, 1);                            /**<    Sets up ADC, SPI, MatrixRGB, Timer */
    /**< Game Setup */
...
void system_setup( uint8_t width, uint8_t height )
{
    ...
    matrixrgb_init( width, height );         /**< Initialize MatrixRGB Click, with brightness of 100, and width of 1 panel by height of 2 panels */
    Delay_ms(200);
